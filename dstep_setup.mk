...
WAMR_HFILES_COMMON:=wasm_runtime_common.h wasm_native.h wasm_exec_env.h wasm_c_api.h
...
$(WAMR_DI_ROOT)/wasm_export.di:WAMR_FLAGS+=--global-import $(WAMR_PACKAGE).wasm_c_api
...
$(WAMR_DI_ROOT)/wasm_runtime_common.di:WAMR_FLAGS+=--global-import $(WAMR_PACKAGE).wasm_c_api


$(WAMR_DI_ROOT)/wasm_c_api.di:WAMR_FLAGS+=--global-import $(WAMR_PACKAGE).wasm_export
...
$(WAMR_DI_ROOT)/wasm_c_api.di:DSTEP_CORRECT_2:=$(SCRIPTROOT)/dtype_stdint.pl
...
$(WAMR_DI_ROOT)/wasm_c_api.di:DSTEP_CORRECT_2:=$(SCRIPTROOT)/wasm_c_api.pl
